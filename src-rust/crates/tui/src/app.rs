...
fn get_env_var_for_provider(id: &str) -> &'static str {
    match id {
        ...
        "bedrock-mantle" => "BEDROCK_MANTLE_API_KEY",
...
fn get_url_for_provider(id: &str) -> &'static str {
    match id {
        ...
        "bedrock-mantle" => "console.aws.amazon.com/bedrock",
...
fn provider_picker_items() -> Vec<SelectItem> {
    vec![
        ...
        SelectItem { id: "bedrock-mantle".into(), title: "AWS Bedrock Mantle".into(), description: "OpenAI-compatible Bedrock endpoint".into(), category: "Other".into(), badge: None },
